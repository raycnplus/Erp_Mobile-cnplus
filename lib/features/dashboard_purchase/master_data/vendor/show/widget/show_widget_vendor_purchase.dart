...
// import 'package:shimmer/shimmer.dart'; // Shimmer sudah di-import di shimmer widget
import '../../../../../../../services/api_base.dart';
import '../models/show_models_vendor_purchase.dart'; // DIUBAH: Model ke purchase
import 'vendor_detail_shimmer_purchase.dart';
...
class _VendorDetailWidgetState extends State<VendorDetailWidget> with SingleTickerProviderStateMixin {
  ...
  VendorShowModel? vendor; // Nama model sama, hanya import beda
  bool isLoading = true;
  String? errorMessage;
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return const VendorDetailShimmerPurchase(); // Menggunakan shimmer
    }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          CustomTabBar( // Menggunakan custom tab bar
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Row(
                  children: [
                    // DIUBAH: .withOpacity(0.8) -> .withAlpha(204)
                    Icon(Icons.qr_code_2, size: 16, color: accentColor.withAlpha(204)),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    // DIUBAH: .withOpacity(0.1) -> .withAlpha(26)
    ...
    return ListView(
      ...
      children: [
        _buildInfoCard(
          ...
          children: [
            // DIUBAH: Menghapus category dan productType
  ...
  Widget _buildContactAddressTab(VendorShowModel vendor) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        _buildInfoCard(
          title: "Company Contact & Address", // Judul diubah
          children: [
            // DITAMBAH: Info kontak perusahaan
            // DIUBAH: Icons.phone_business_outlined -> Icons.local_phone_outlined
            _buildInfoTile(Icons.local_phone_outlined, "Company Phone", safe(vendor.phoneNo)),
            _buildInfoTile(Icons.alternate_email_outlined, "Company Email", safe(vendor.email)),
  ...
  Widget _buildInfoCard({required String title, required List<Widget> children}) {
    return Card(
      elevation: 2,
      // DIUBAH: .withOpacity(0.05) -> .withAlpha(13)
...
// Widget kustom untuk TabBar (sama seperti di file inventory)
    ...
    return Container(
      ...
      child: TabBar(
        ...
        indicator: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              // DIUBAH: .withOpacity(0.4) -> .withAlpha(102)
