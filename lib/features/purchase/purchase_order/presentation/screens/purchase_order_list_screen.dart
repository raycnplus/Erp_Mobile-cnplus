...
import 'package:erp_mobile_cnplus/features/purchase/purchase_order/presentation/widgets/purchase_order_list_item.dart';
...
class _PurchaseOrderListScreenState extends State<PurchaseOrderListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<PurchaseOrderController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      ...
      context.read<PurchaseOrderController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<PurchaseOrderController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<PurchaseOrderController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
          ...
          Expanded(
            child: Consumer<PurchaseOrderController>(
              builder: (_, ctrl, __) {
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => PurchaseOrderListItem(
                            po: ctrl.pageItems[i],
  ...
  Widget _buildErrorState(PurchaseOrderController ctrl) {
    return Center(
      child: Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Purchase order not found' : 'No purchase orders yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
