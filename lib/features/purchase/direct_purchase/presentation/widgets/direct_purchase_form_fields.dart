...
class DirectPurchaseFormFields extends StatefulWidget {
  final DirectPurchaseFormModel formData;
  final DirectPurchaseFormOptions? formOptions;
  final VoidCallback onSave;
  final bool isSaving;

  const DirectPurchaseFormFields({
    super.key,
  ...
  @override
  State<DirectPurchaseFormFields> createState() => _State();
}

class _State extends State<DirectPurchaseFormFields> with TickerProviderStateMixin {
  ...
  DirectPurchaseFormOptions? get _opts => widget.formOptions;
  ...
  Future<void> _addProduct() async {
    ...
    DirectPurchaseProductOption? selected;
    DirectPurchaseUomOption? selectedUom;
        ...
        builder: (ctx, setSt) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                CustomSearchableDropdown<DirectPurchaseProductOption>(
                  value: selected,
                  items: products,
                ...
                CustomSearchableDropdown<DirectPurchaseUomOption>(
                  value: selectedUom,
                  items: _opts?.uoms ?? [],
                  itemLabel: (u) => u.name,
    ...
    if (result != null && mounted) {
      final prod = result['product'] as DirectPurchaseProductOption;
      final uom = result['uom'] as DirectPurchaseUomOption;
      double unitPrice = 0;
      if (widget.formData.idPriceList != null) {
        unitPrice = await ctrl.fetchPriceFromList(prod.idProduct, widget.formData.idPriceList!) ?? 0;
      }
      setState(() {
        widget.formData.items.add(DirectPurchaseFormItem(
  ...
  List<DirectPurchaseLocationOption> _getFilteredLocations() {
  ...
  Widget _buildHeaderTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          CustomSearchableDropdown<DirectPurchaseVendorOption>(
          ...
          CustomSearchableDropdown<DirectPurchaseWarehouseOption>(
          ...
          CustomSearchableDropdown<DirectPurchaseLocationOption>(
          ...
          CustomSearchableDropdown<DirectPurchasePriceListOption>(
          ...
          CustomFormInput(
            ...
            label: 'Note',
            hintText: 'Write note for this Direct Purchase (optional)',
            maxLines: 3,
          ),
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Add products to direct purchase from vendor',
  ...
  Widget _buildBottomBar() => Container(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(
              widget.formData.isEditMode ? 'Update Direct Purchase' : 'Save Direct Purchase',
