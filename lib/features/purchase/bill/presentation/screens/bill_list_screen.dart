...
import 'package:erp_mobile_cnplus/features/purchase/bill/presentation/widgets/bill_list_item.dart';
...
class BillListScreen extends StatefulWidget {
  ...
  @override
  State<BillListScreen> createState() {
    return _State();
  }
}

class _State extends State<BillListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<BillController>().fetchList();
    });
  }
  ...
  void _goToForm() {
    Navigator.push(
      ...
      context.read<BillController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) {
                context.read<BillController>().search(v);
              },
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<BillController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
  ...
  Widget _buildErrorState(BillController ctrl) {
    return Center(
      child: Padding(
  ...
  Widget _buildEmptyState(bool isSearching) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            isSearching ? Icons.search_off : Icons.receipt_outlined,
            size: 80,
            color: colorGrey,
          ),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Bill not found' : 'No bills yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
