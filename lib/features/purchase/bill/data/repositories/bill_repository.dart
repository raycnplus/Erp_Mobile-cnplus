...
class BillRepository {
  final BillRemoteDataSource ds;

  BillRepository(this.ds);
  ...
  Future<BillDetailModel> getDetail(String enc) => ds.getDetail(enc);

  Future<BillFormOptions> getFormOptions() => ds.getFormOptions();
