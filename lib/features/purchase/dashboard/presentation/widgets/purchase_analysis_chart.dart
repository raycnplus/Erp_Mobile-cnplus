...
class PurchaseAnalysisChart extends StatelessWidget {
  ...
  String _getDateRange() {
    ...
    final firstMonth = DateFormat('MMM yyyy').format(DateTime(purchaseData.first.year, purchaseData.first.month));
    final lastMonth  = DateFormat('MMM yyyy').format(DateTime(purchaseData.last.year,  purchaseData.last.month));
        ...
        getTooltipItems: (touchedSpots) {
          return touchedSpots.map((spot) {
            ...
            return LineTooltipItem(
              '$monthName ${spot.x == purchaseData.first.month.toDouble() ? purchaseData.first.year : purchaseData.last.year}\n',
