...
import 'package:erp_mobile_cnplus/features/purchase/request_quotation/presentation/widgets/rfq_list_item.dart';
...
class _RfqListScreenState extends State<RfqListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<RfqController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const RfqFormScreen()),
    ).then((_) {
      context.read<RfqController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<RfqController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<RfqController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => RfqListItem(
                            rfq: ctrl.pageItems[i],
  ...
  Widget _buildErrorState(RfqController ctrl) {
    return Center(
      child: Padding(
  ...
  Widget _buildEmptyState(bool isSearching) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            isSearching ? Icons.search_off : Icons.request_quote_outlined,
            size: 80,
            color: colorGrey,
          ),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'RFQ not found' : 'No RFQs yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
