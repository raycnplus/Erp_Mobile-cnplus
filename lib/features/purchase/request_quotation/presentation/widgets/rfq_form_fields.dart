...
class RfqFormFields extends StatefulWidget {
  final RfqFormModel formData;
  final RfqFormOptions? formOptions;
  ...
  @override
  State<RfqFormFields> createState() => _State();
}

class _State extends State<RfqFormFields> with TickerProviderStateMixin {
  late TabController _tab;
  final _noteCtrl = TextEditingController();
  final _prRefCtrl = TextEditingController();
  ...
  void _removeSchedCtrls(int i) {
    ...
    for (int j = i + 1; j <= widget.formData.schedules.length; j++) {
      for (final field in ['termName', 'amount', 'percentage', 'description']) {
  ...
  void initState() {
    ...
    _prRefCtrl.text = widget.formData.prReference ?? '';
  }
  ...
  RfqFormOptions? get _opts => widget.formOptions;
  ...
  bool _validateAndSync() {
    ...
    widget.formData.prReference = _prRefCtrl.text.trim().isEmpty ? null : _prRefCtrl.text.trim();
  ...
  Future<void> _addProduct() async {
    ...
    RfqProductOption? selected;
    RfqUomOption? selectedUom;
        ...
        builder: (ctx, setSt) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                CustomSearchableDropdown<RfqProductOption>(
                  value: selected,
                  items: products,
                ...
                CustomSearchableDropdown<RfqUomOption>(
                  value: selectedUom,
                  items: _opts?.uoms ?? [],
                  itemLabel: (u) => u.name,
  ...
  List<RfqLocationOption> _getFilteredLocations() {
  ...
  Widget _buildHeaderTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          CustomSearchableDropdown<RfqVendorOption>(
          ...
          CustomSearchableDropdown<RfqWarehouseOption>(
          ...
          CustomSearchableDropdown<RfqLocationOption>(
          ...
          CustomSearchableDropdown<RfqPurchaseTeamOption>(
          ...
          CustomSearchableDropdown<RfqPurchasePersonOption>(
            key: ValueKey('pp_${widget.formData.purchasePerson}_${_opts?.purchasePersons.length}'),
          ...
          CustomFormInput(
            controller: _prRefCtrl,
            label: 'PR Reference',
            hintText: 'Purchase request reference (optional)',
          ),
          const SizedBox(height: 14),
          ...
          CustomSearchableDropdown<RfqPaymentTermOption>(
          ...
          CustomSearchableDropdown<RfqPriceListOption>(
          ...
          CustomFormInput(
            ...
            label: 'Note',
            hintText: 'Write note for this RFQ (optional)',
            maxLines: 3,
          ),
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Add products to request quotation for',
  ...
  Widget _buildSchedulesTab() {
    final total    = widget.formData.subtotal;
    final totalPct = widget.formData.totalSchedulePercentage;
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Subtotal (before PPN): Rp ${_fmtNum(total)}',
  ...
  void _addSchedule() {
    setState(() {
      widget.formData.schedules.add(RfqScheduleItem(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: _numFieldItem(
                    ...
                    onChanged: (v) => setState(() {
                      ...
                      s.amount     = total * (s.percentage / 100);
                ...
                Expanded(
                  child: _numFieldItem(
                    ...
                    onChanged: (v) => setState(() {
                      s.amount     = v;
                      s.percentage = total > 0 ? (v / total * 100) : 0;
            ...
            const SizedBox(height: 8),
            CustomFormInput(
              controller: _schedCtrl(i, 'description', s.description ?? ''),
              label: 'Description',
              hintText: 'Optional note for this term',
              onChanged: (v) => s.description = v.trim().isEmpty ? null : v.trim(),
            ),
          ],
        ),
      ),
  ...
  Widget _buildTotalsFooter() => Container(
        ...
        child: Column(
          children: [
            ...
            _footerRow('Subtotal', 'Rp ${_fmtNum(widget.formData.subtotal)}'),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'Rp ${_fmtNum(widget.formData.totalAmount)}',
                  style: GoogleFonts.poppins(
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                    color: colorPrimary,
  ...
  Widget _buildBottomBar() => Container(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(
              widget.formData.isEditMode ? 'Update RFQ' : 'Save RFQ',
