...
import 'package:erp_mobile_cnplus/features/pos/store/presentation/widgets/store_list_item.dart';
...
class _StoreListScreenState extends State<StoreListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<StoreController>().fetchList(),
    );
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<StoreController>().search(v),
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => StoreListItem(
                            store: ctrl.pageItems[i],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Store not found' : 'No stores yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
