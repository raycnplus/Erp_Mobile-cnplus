...
class PositionDetailTabs extends StatefulWidget {
  final PositionDetailModel detail;

  const PositionDetailTabs({super.key, required this.detail});

  @override
  State<PositionDetailTabs> createState() => _PositionDetailTabsState();
}

class _PositionDetailTabsState extends State<PositionDetailTabs>
  ...
  Widget build(BuildContext context) {
    final p = widget.detail.position;
    return Column(
      children: [
        TabBar(
          controller: _tab,
          ...
          child: TabBarView(
            ...
            children: [
              SingleChildScrollView(
                ...
                child: _card('Position Info', Icons.work_outline, {
                  'Name': _safe(p.positionName),
                  'Description': p.positionDescription?.isNotEmpty == true
