...
class NationalHolidayDetailTabs extends StatefulWidget {
  final NationalHolidayDetailModel detail;

  const NationalHolidayDetailTabs({super.key, required this.detail});

  @override
  State<NationalHolidayDetailTabs> createState() => _NationalHolidayDetailTabsState();
}

class _NationalHolidayDetailTabsState extends State<NationalHolidayDetailTabs>
          ...
          child: TabBarView(
            ...
            children: [
              SingleChildScrollView(
                ...
                child: _card('Holiday Info', Icons.event_outlined, {
                  'Holiday Name': _safe(h.holidayName),
                  'Date': _fmtDate(h.holidayDate),
                }),
              ),
              SingleChildScrollView(
                padding: const EdgeInsets.all(16),
