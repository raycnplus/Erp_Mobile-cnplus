...
class DepartmentDetailTabs extends StatefulWidget {
  final DepartmentDetailModel detail;
  const DepartmentDetailTabs({super.key, required this.detail});

  @override
  State<DepartmentDetailTabs> createState() => _DepartmentDetailTabsState();
}

class _DepartmentDetailTabsState extends State<DepartmentDetailTabs>
  ...
  String _fmt(String? d) {
    ...
    try { return DateFormat('d MMMM yyyy, hh:mm a').format(DateTime.parse(d)); }
    catch (_) { return d; }
  }
  ...
  Widget build(BuildContext context) {
    final d = widget.detail.department;
      ...
      Expanded(
        child: TabBarView(controller: _tabController, children: [
          SingleChildScrollView(
            ...
            child: _card("Department Info", Icons.apartment_outlined, {
              "Name": _safe(d.departmentName),
              "Description": d.departmentDescription?.isNotEmpty == true
  ...
  Widget _card(String title, IconData icon, Map<String, String> fields) {
    final visible = {for (final e in fields.entries) if (e.value != '-') e.key: e.value};
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            Text(title, style: GoogleFonts.poppins(
                fontWeight: FontWeight.bold, fontSize: 16, color: colorTextPrimary)),
          ]),
              ...
              children: [
                ...
                Flexible(child: Text(e.value,
                    ...
                    style: GoogleFonts.poppins(
                        fontWeight: FontWeight.w500, color: colorTextPrimary, fontSize: 14))),
              ]),
          )),
        ]),
      ),
