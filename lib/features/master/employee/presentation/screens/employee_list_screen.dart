...
import 'package:erp_mobile_cnplus/features/master/employee/presentation/widgets/employee_list_item.dart';
...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<EmployeeController>().fetchList();
      context.read<EmployeeController>().fetchFormDropdownData();
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<EmployeeController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<EmployeeController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => EmployeeListItem(
                            employee: ctrl.pageItems[i],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Employee not found' : 'No employees yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
