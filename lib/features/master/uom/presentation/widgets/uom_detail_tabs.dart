...
class UomDetailTabs extends StatefulWidget {
  final UomDetailModel detail;

  const UomDetailTabs({super.key, required this.detail});

  @override
  State<UomDetailTabs> createState() => _UomDetailTabsState();
}

class _UomDetailTabsState extends State<UomDetailTabs>
  ...
  String _qty(double q) => q % 1 == 0 ? q.toStringAsFixed(0) : q.toStringAsFixed(4);
          ...
          child: TabBarView(
            ...
            children: [
              SingleChildScrollView(
                ...
                child: _infoCard('UoM Info', Icons.straighten, {
                  'Name': _safe(d.uom.uomName),
                  'Quantity': _qty(d.uom.quantity),
                  'Reference Unit': d.uom.referenceUnitName?.isNotEmpty == true
                      ? d.uom.referenceUnitName!
                      : '-',
                }),
              ),
              SingleChildScrollView(
