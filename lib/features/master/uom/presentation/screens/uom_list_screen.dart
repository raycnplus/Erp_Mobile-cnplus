...
import 'package:erp_mobile_cnplus/features/master/uom/presentation/widgets/uom_list_item.dart';
...
class _UomListScreenState extends State<UomListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<UomController>().fetchList(),
    );
  }
  ...
  void _goToForm() => Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const UomFormScreen()),
      );
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<UomController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<UomController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => UomListItem(
                            uom: ctrl.pageItems[i],
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => UomDetailScreen(
  ...
  Widget _buildEmptyState(bool isSearching) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            isSearching ? Icons.search_off : Icons.straighten,
            size: 80,
            color: colorGrey,
          ),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'UoM not found' : 'No UoM yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
