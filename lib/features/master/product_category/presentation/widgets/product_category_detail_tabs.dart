...
class ProductCategoryDetailTabs extends StatelessWidget {
  final ProductCategoryDetailModel categoryDetail;

  const ProductCategoryDetailTabs({super.key, required this.categoryDetail});
      ...
      child: Column(
        ...
        children: [
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.category_outlined,
                        color: colorPrimary, size: 32),
                  ),
                  const SizedBox(width: 16),
                  Expanded(
                    child: Text(
                      categoryDetail.category.productCategoryName,
          ...
          _buildDetailsCard("Creation", Icons.add_circle_outline, {
            "Created By": _safe(categoryDetail.createdByName),
            "Created On":
                _formatDate(categoryDetail.category.createdDate),
          }),
          const SizedBox(height: 12),
          _buildDetailsCard("Last Update", Icons.update_outlined, {
            "Updated By": _safe(categoryDetail.updatedByName),
            "Updated On":
                _formatDate(categoryDetail.category.updatedDate),
          }),
        ],
      ),
    );
