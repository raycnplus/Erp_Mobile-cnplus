...
import 'package:erp_mobile_cnplus/features/master/product_category/presentation/widgets/product_category_list_item.dart';
...
class _ProductCategoryListScreenState extends State<ProductCategoryListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ProductCategoryController>().fetchCategoryList();
    });
  }
  ...
  void _onSearchChanged(String value) {
    context.read<ProductCategoryController>().searchCategories(value);
  }

  void _clearSearch() {
    _searchController.clear();
    context.read<ProductCategoryController>().clearSearch();
  }

  Future<void> _handleRefresh() async {
    await context.read<ProductCategoryController>().fetchCategoryList();
  }

  void _navigateToCreate() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const ProductCategoryFormScreen()),
    );
  }
  ...
  void _navigateToDetail(String encryption) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            ProductCategoryDetailScreen(encryption: encryption),
      ),
    );
  }
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ProductCategoryListItem(
                              category: cat,
                              onTap: () => _navigateToDetail(cat.encryption),
                            );
                          },
                        ),
                      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              isSearching ? 'Category not found' : 'No categories yet',
              style: GoogleFonts.poppins(
                  fontSize: 18,
