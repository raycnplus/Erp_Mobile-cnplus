...
class PurchaseTeamDetailTabs extends StatefulWidget {
  final PurchaseTeamDetailModel teamDetail;
  const PurchaseTeamDetailTabs({super.key, required this.teamDetail});

  @override
  State<PurchaseTeamDetailTabs> createState() =>
      _PurchaseTeamDetailTabsState();
}

class _PurchaseTeamDetailTabsState extends State<PurchaseTeamDetailTabs>
                ...
                child: Column(
                  children: [
                    _card("Team Info", Icons.groups_outlined, {
                      ...
                      "Team Leader": _safe(t.teamLeaderName),
                      "Description": t.description?.isNotEmpty == true
                          ? t.description!
                          : '-',
                    }),
                    const SizedBox(height: 16),
                    _buildMembersCard(t.members),
                  ],
                ),
              ),
              SingleChildScrollView(
  ...
  Widget _buildMembersCard(List<PurchaseMemberData> members) {
    return Card(
      elevation: 2,
