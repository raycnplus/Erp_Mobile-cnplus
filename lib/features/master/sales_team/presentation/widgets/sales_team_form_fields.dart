...
class SalesTeamFormFields extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final SalesTeamFormModel formData;
  final VoidCallback onSubmit;
  final bool isEditMode;
  final SalesTeamDropdownData? dropdownData;
  final bool isLoadingDropdown;

  const SalesTeamFormFields({
    super.key,
  ...
  @override
  State<SalesTeamFormFields> createState() => _SalesTeamFormFieldsState();
}

class _SalesTeamFormFieldsState extends State<SalesTeamFormFields>
  ...
  void initState() {
    ...
    if (widget.dropdownData != null) _syncFromDropdown();
  }
  ...
  @override
  void didUpdateWidget(SalesTeamFormFields oldWidget) {
  ...
  UserDropdown? _findUser(int? id) {
    ...
    final matches = widget.dropdownData!.users.where((u) => u.id == id);
          ...
          child: filteredUsers.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.person_search, size: 64, color: colorGreyLight),
