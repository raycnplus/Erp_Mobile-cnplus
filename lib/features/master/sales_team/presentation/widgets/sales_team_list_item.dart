...
class SalesTeamListItem extends StatelessWidget {
  final SalesTeamModel team;
  final VoidCallback onTap;

  const SalesTeamListItem({super.key, required this.team, required this.onTap});
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (team.teamLeaderName.isNotEmpty && team.teamLeaderName != '-')
                      Row(children: [
                        const Icon(Icons.person_outline,
                            size: 13, color: colorTextSubtle),
                        const SizedBox(width: 4),
                        Flexible(
                          child: Text(team.teamLeaderName,
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: GoogleFonts.poppins(
                    ...
                    const SizedBox(height: 4),
                    Row(children: [
                      const Icon(Icons.group, size: 13, color: colorGrey),
                      const SizedBox(width: 4),
