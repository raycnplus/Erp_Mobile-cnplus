...
import 'package:erp_mobile_cnplus/features/master/project/presentation/widgets/project_list_item.dart';
...
class _ProjectListScreenState extends State<ProjectListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ProjectController>().fetchList();
      context.read<ProjectController>().fetchFormOptions();
    });
  }
      ...
      body: Column(children: [
        Container(
          ...
          child: TextField(
            ...
            onChanged: (v) => context.read<ProjectController>().search(v),
            decoration: InputDecoration(
              ...
              suffixIcon: _searchCtrl.text.isNotEmpty
                  ? IconButton(
                      ...
                      onPressed: () {
                        _searchCtrl.clear();
                        context.read<ProjectController>().clearSearch();
                      },
                    )
                  : null,
              filled: true,
        ...
        Expanded(
          child: Consumer<ProjectController>(builder: (_, ctrl, __) {
              ...
              Expanded(
                child: RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, i) => ProjectListItem(
                      project: ctrl.pageItems[i],
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => ProjectDetailScreen(encryption: ctrl.pageItems[i].encryption),
                        ),
                      ),
                    ),
                  ),
  ...
  Widget _buildEmptyState(bool isSearching) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(isSearching ? Icons.search_off : Icons.folder_outlined,
              size: 80, color: colorGrey),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Project not found' : 'No projects yet',
