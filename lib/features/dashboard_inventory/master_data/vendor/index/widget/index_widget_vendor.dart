...
class _VendorIndexWidgetState extends State<VendorIndexWidget> {
  ...
  // Fungsi deleteVendor Dihapus (Sesuai permintaan)
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // Gunakan warna hijau sebagai indikator status (jika email terisi)
          Color statusColor = vendor.email.isNotEmpty ? primaryAccent : Colors.orange.shade600;

          return Card(
            color: Colors.white,
            elevation: 3, // Shadow tipis
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // === 1. TOP SECTION: Vendor Name & Status ===
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            vendor.vendorName.isNotEmpty ? vendor.vendorName : "No Name Provided",
                            maxLines: 2,
  ...
  Widget _buildDetailRow(IconData icon, String label, String value, {Color? color}) {
    String safeValue = value.isNotEmpty ? value : "-";
    ...
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 8),
        SizedBox(
          width: 60, // Lebar tetap untuk Label agar rapi
          child: Text(
            "$label:",
            style: GoogleFonts.poppins(
