...
import 'package:erp_mobile_cnplus/features/manufacturing/workstation/presentation/widgets/workstation_list_item.dart';
import 'package:erp_mobile_cnplus/core/utils/colors.dart';
import 'package:erp_mobile_cnplus/shared/widgets/pagination_bottom_bar.dart';
import 'workstation_detail_screen.dart';
...
class _WorkstationListScreenState extends State<WorkstationListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<WorkstationController>().fetchList(),
    );
  }
  ...
  void _goToForm() => Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const WorkstationFormScreen()),
      );
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<WorkstationController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<WorkstationController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
          ...
          Expanded(
            child: Consumer<WorkstationController>(
              builder: (_, ctrl, __) {
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => WorkstationListItem(
                            workstation: ctrl.pageItems[i],
  ...
  Widget _buildEmptyState(bool isSearching) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            isSearching ? Icons.search_off : Icons.precision_manufacturing_outlined,
            size: 80,
            color: colorGrey,
          ),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Workstation not found' : 'No workstations yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
