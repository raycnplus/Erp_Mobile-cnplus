...
import 'package:erp_mobile_cnplus/features/sales/service_sales/service_sales_order/presentation/widgets/service_sales_order_list_item.dart';
import 'package:erp_mobile_cnplus/core/utils/colors.dart';
import 'package:erp_mobile_cnplus/shared/widgets/pagination_bottom_bar.dart';
import 'service_sales_order_detail_screen.dart';
import 'service_sales_order_form_screen.dart';

class ServiceSalesOrderListScreen extends StatefulWidget {
  const ServiceSalesOrderListScreen({super.key});

  @override
  State<ServiceSalesOrderListScreen> createState() => _State();
}

class _State extends State<ServiceSalesOrderListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<ServiceSalesOrderController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const ServiceSalesOrderFormScreen()),
    ).then((_) {
      context.read<ServiceSalesOrderController>().fetchList(status: _selectedStatus);
    });
  }
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              'Service sales order management',
              style: GoogleFonts.poppins(
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) =>
                  context.read<ServiceSalesOrderController>().search(v),
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context
                              .read<ServiceSalesOrderController>()
                              .clearSearch();
                        },
                      )
                    : null,
          ...
          Expanded(
            child: Consumer<ServiceSalesOrderController>(
              builder: (_, ctrl, __) {
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            '${ctrl.total} service sales orders',
                            style: GoogleFonts.poppins(
                              fontSize: 12,
                              color: colorTextSubtle,
                            ),
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => ServiceSalesOrderListItem(
                            sso: ctrl.pageItems[i],
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => ServiceSalesOrderDetailScreen(
                                  encryption:
  ...
  Widget _buildErrorState(ServiceSalesOrderController ctrl) {
    return Center(
      child: Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Service sales order not found' : 'No service sales orders yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
          ...
          if (isSearching) ...[
            ...
            TextButton.icon(
              onPressed: () {
                _searchCtrl.clear();
                context.read<ServiceSalesOrderController>().clearSearch();
              },
