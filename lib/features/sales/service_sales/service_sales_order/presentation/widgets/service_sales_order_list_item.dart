...
class ServiceSalesOrderListItem extends StatelessWidget {
  final ServiceSalesOrderModel sso;
  final VoidCallback onTap;

  const ServiceSalesOrderListItem({
    super.key,
    required this.sso,
    required this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    final color = Color(sso.statusColor);
    return Card(
      color: colorCard,
      elevation: 2,
