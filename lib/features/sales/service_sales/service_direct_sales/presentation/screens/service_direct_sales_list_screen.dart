...
import 'package:erp_mobile_cnplus/features/sales/service_sales/service_direct_sales/presentation/widgets/service_direct_sales_list_item.dart';
import 'package:erp_mobile_cnplus/core/utils/colors.dart';
import 'package:erp_mobile_cnplus/shared/widgets/pagination_bottom_bar.dart';
import 'service_direct_sales_detail_screen.dart';
import 'service_direct_sales_form_screen.dart';

class ServiceDirectSalesListScreen extends StatefulWidget {
  const ServiceDirectSalesListScreen({super.key});

  @override
  State<ServiceDirectSalesListScreen> createState() => _State();
}

class _State extends State<ServiceDirectSalesListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<ServiceDirectSalesController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const ServiceDirectSalesFormScreen()),
    ).then((_) {
      context.read<ServiceDirectSalesController>().fetchList(status: _selectedStatus);
    });
  }
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              'Service direct sales management',
              style: GoogleFonts.poppins(
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) =>
                  context.read<ServiceDirectSalesController>().search(v),
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context
                              .read<ServiceDirectSalesController>()
                              .clearSearch();
                        },
                      )
                    : null,
          ...
          Expanded(
            child: Consumer<ServiceDirectSalesController>(
              builder: (_, ctrl, __) {
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            '${ctrl.total} service direct sales',
                            style: GoogleFonts.poppins(
                              fontSize: 12,
                              color: colorTextSubtle,
                            ),
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => ServiceDirectSalesListItem(
                            sds: ctrl.pageItems[i],
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => ServiceDirectSalesDetailScreen(
  ...
  Widget _buildErrorState(ServiceDirectSalesController ctrl) {
    return Center(
      child: Padding(
  ...
  Widget _buildEmptyState(bool isSearching) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            isSearching ? Icons.search_off : Icons.point_of_sale_outlined,
            size: 80,
            color: colorGrey,
          ),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Service direct sales not found' : 'No service direct sales yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
          ...
          if (isSearching) ...[
            ...
            TextButton.icon(
              onPressed: () {
                _searchCtrl.clear();
                context.read<ServiceDirectSalesController>().clearSearch();
              },
