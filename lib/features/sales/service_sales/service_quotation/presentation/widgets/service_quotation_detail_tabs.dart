...
class ServiceQuotationDetailTabs extends StatefulWidget {
  final ServiceQuotationDetailModel detail;

  const ServiceQuotationDetailTabs({super.key, required this.detail});

  @override
  State<ServiceQuotationDetailTabs> createState() => _State();
}

class _State extends State<ServiceQuotationDetailTabs>
  ...
  Widget _buildServicesTab(ServiceQuotationDetailModel d) {
    return Column(
      children: [
        Expanded(
  ...
  Widget _buildInfoTab(ServiceQuotationDetailModel d) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        children: [
          _infoCard('Quotation Info', Icons.design_services_outlined, [
          ...
          if (d.hasSSO) ...[
            const SizedBox(height: 12),
            _infoCard('Service Sales Order', Icons.assignment_outlined, [
              _row('SSO Created', 'Yes'),
            ]),
          ],
        ],
      ),
  ...
  Widget _buildOthersTab(ServiceQuotationDetailModel d) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        children: [
