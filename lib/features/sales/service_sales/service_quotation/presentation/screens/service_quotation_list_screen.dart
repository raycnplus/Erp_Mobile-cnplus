...
import 'package:erp_mobile_cnplus/features/sales/service_sales/service_quotation/presentation/widgets/service_quotation_list_item.dart';
import 'package:erp_mobile_cnplus/core/utils/colors.dart';
import 'package:erp_mobile_cnplus/shared/widgets/pagination_bottom_bar.dart';
import 'service_quotation_detail_screen.dart';
...
class ServiceQuotationListScreen extends StatefulWidget {
  ...
  @override
  State<ServiceQuotationListScreen> createState() => _State();
}

class _State extends State<ServiceQuotationListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<ServiceQuotationController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const ServiceQuotationFormScreen()),
    ).then((_) {
      context.read<ServiceQuotationController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) =>
                  context.read<ServiceQuotationController>().search(v),
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context
                              .read<ServiceQuotationController>()
                              .clearSearch();
                        },
                      )
                    : null,
          ...
          Expanded(
            child: Consumer<ServiceQuotationController>(
              builder: (_, ctrl, __) {
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => ServiceQuotationListItem(
                            q: ctrl.pageItems[i],
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) =>
                                    ServiceQuotationDetailScreen(
                                  encryption:
  ...
  Widget _buildErrorState(ServiceQuotationController ctrl) {
    return Center(
      child: Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Service quotation not found' : 'No service quotations yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
          ...
          if (isSearching) ...[
            ...
            TextButton.icon(
              onPressed: () {
                _searchCtrl.clear();
                context.read<ServiceQuotationController>().clearSearch();
              },
