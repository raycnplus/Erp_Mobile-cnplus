...
class ServiceQuotationRemoteDataSource {
  final Dio dio;

  ServiceQuotationRemoteDataSource(this.dio);
    ...
    try {
      ...
      return {
        'items': (pd['data'] as List)
            .map((e) => ServiceQuotationModel.fromJson(e))
            .toList(),
        'meta': ServiceQuotationPaginationMeta(
  ...
  Future<ServiceQuotationDetailModel> getDetail(String enc) async {
    try {
      final r = await dio.get('/sales/service/quotations/$enc');
      return ServiceQuotationDetailModel.fromJson(r.data);
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }

  Future<ServiceQuotationFormOptions> getFormOptions() async {
    try {
      final results = await Future.wait([
        dio.get('/sales/service/quotations/form-options'),
        dio.get('/sales/service/quotations/service-list'),
      ]);
      ...
      return ServiceQuotationFormOptions.fromJson({'data': optData});
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<void> cancel(int id, String reason) async {
    try {
      await dio.post(
        '/sales/service/quotations/$id/cancel',
  ...
  Future<void> delete(int id) async {
    try {
      await dio.delete('/sales/service/quotations/$id');
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }

  Future<Map<String, dynamic>> createSSO(int id) async {
    try {
      final r =
          await dio.post('/sales/service/quotations/$id/create-sso');
  ...
  Future<double?> getPriceFromList(int serviceId, int priceListId) async {
    try {
      final r = await dio.get(
        '/sales/service/quotations/price-from-list',
        queryParameters: {
  ...
  Future<void> approve(int id) async {
    try {
      await dio.post('/sales/service/quotations/$id/approve');
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<void> reject(int id) async {
    try {
      await dio.post('/sales/service/quotations/$id/reject');
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<Map<String, dynamic>> getSteps(int id) async {
    try {
      final r =
          await dio.get('/sales/service/quotations/$id/steps');
      return r.data as Map<String, dynamic>;
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
