...
class DirectSalesListItem extends StatelessWidget {
  final DirectSalesModel ds;
  final VoidCallback onTap;

  const DirectSalesListItem({
    super.key,
    required this.ds,
    required this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    final color = Color(ds.statusColor);
    return Card(
      color: colorCard,
      elevation: 2,
