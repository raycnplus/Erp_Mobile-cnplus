...
class SalesOrderFormFields extends StatefulWidget {
  final SalesOrderFormModel formData;
  final SalesOrderFormOptions? formOptions;
  ...
  @override
  State<SalesOrderFormFields> createState() => _State();
}

class _State extends State<SalesOrderFormFields> with TickerProviderStateMixin {
  ...
  SalesOrderFormOptions? get _opts => widget.formOptions;
  ...
  bool _validateAndSync() {
    ...
    widget.formData.poNumber        = _poCtrl.text.trim().isEmpty ? null : _poCtrl.text.trim();
  ...
  Future<void> _addProduct() async {
        ...
        builder: (ctx, setSt) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                CustomSearchableDropdown<SOProductOption>(
                  value: selected,
                  items: products,
    ...
    if (result != null && mounted) {
      final prod = result['product'] as SOProductOption;
      ...
      setState(() {
        widget.formData.items.add(SalesOrderFormItem(
  ...
  Widget _buildHeaderTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          CustomSearchableDropdown<SOCustomerOption>(
          ...
          CustomSearchableDropdown<SOSalesPersonOption>(
          ...
          _datePicker(
            ...
            hint: 'Select order date (optional)',
          ...
          CustomSearchableDropdown<SOPaymentTermOption>(
          ...
          CustomSearchableDropdown<SOPriceListOption>(
          ...
          CustomFormInput(
            ...
            label: 'Note',
            hintText: 'Write note for this sales order (optional)',
            maxLines: 3,
          ),
  ...
  void _addSchedule() {
    setState(() {
      widget.formData.schedules.add(SalesOrderScheduleItem(
  ...
  Widget _buildBottomBar() => Container(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(
              widget.formData.isEditMode ? 'Update Sales Order' : 'Save Sales Order',
