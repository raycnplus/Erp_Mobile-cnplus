...
import 'package:erp_mobile_cnplus/features/sales/sales_order/presentation/widgets/sales_order_list_item.dart';
...
class _SalesOrderListScreenState extends State<SalesOrderListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<SalesOrderController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      ...
      context.read<SalesOrderController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<SalesOrderController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<SalesOrderController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
          ...
          Expanded(
            child: Consumer<SalesOrderController>(
              builder: (_, ctrl, __) {
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => SalesOrderListItem(
                            so: ctrl.pageItems[i],
  ...
  Widget _buildErrorState(SalesOrderController ctrl) {
    return Center(
      child: Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Sales order not found' : 'No sales orders yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
