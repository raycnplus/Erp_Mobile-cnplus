...
import 'package:erp_mobile_cnplus/features/sales/quotation/presentation/widgets/quotation_list_item.dart';
...
class QuotationListScreen extends StatefulWidget {
  ...
  @override
  State<QuotationListScreen> createState() => _State();
}

class _State extends State<QuotationListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<QuotationController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      ...
      context.read<QuotationController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<QuotationController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<QuotationController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => QuotationListItem(
                            q: ctrl.pageItems[i],
  ...
  Widget _buildErrorState(QuotationController ctrl) {
    return Center(
      child: Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Quotation not found' : 'No quotations yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
