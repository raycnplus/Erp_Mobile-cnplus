...
class InvoiceFormFields extends StatefulWidget {
  final InvoiceFormModel formData;
  final InvoiceFormOptions? formOptions;
  ...
  @override
  State<InvoiceFormFields> createState() => _State();
}

class _State extends State<InvoiceFormFields> with TickerProviderStateMixin {
  ...
  InvoiceFormOptions? get _opts  => widget.formOptions;
  ...
  Future<void> _addProduct() async {
    InvProductOption? selected;
    InvUomOption? selectedUom;
          ...
          content: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  CustomSearchableDropdown<InvProductOption>(
                    value: selected,
                    items: _opts?.products ?? [],
                  ...
                  if (selected != null)
                    CustomSearchableDropdown<InvUomOption>(
                      value: selectedUom,
                      items: _opts?.uoms ?? [],
                      itemLabel: (u) => u.name,
    ...
    if (result != null && mounted) {
      final prod = result['product'] as InvProductOption;
      final uom  = result['uom']    as InvUomOption;

      double unitPrice = prod.unitPrice;
      if (widget.formData.idPriceList != null) {
        final ctrl = context.read<InvoiceController>();
        unitPrice = await ctrl.fetchPriceFromList(prod.idProduct, widget.formData.idPriceList!) ?? prod.unitPrice;
      }

      setState(() {
        widget.formData.items.add(InvoiceFormItem(
  ...
  Widget _buildHeaderTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          CustomSearchableDropdown<InvCustomerOption>(
          ...
          CustomSearchableDropdown<InvSalesPersonOption>(
          ...
          CustomSearchableDropdown<InvPaymentTermOption>(
          ...
          CustomSearchableDropdown<InvPriceListOption>(
          ...
          CustomFormInput(
            ...
            label: 'Note',
            hintText: 'Write note for this invoice (optional)',
            maxLines: 3,
          ),
  ...
  Widget _buildBottomBar() => Container(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(
              widget.formData.isEditMode ? 'Update Invoice' : 'Save Invoice',
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            if (value != null) const Icon(Icons.close, size: 16, color: colorGrey),
          ],
        ),
      ),
    );
