...
import 'package:erp_mobile_cnplus/features/sales/invoice/presentation/widgets/invoice_list_item.dart';
...
class _InvoiceListScreenState extends State<InvoiceListScreen> {
  ...
  static const _statuses = ['Draft', 'Waiting Approval', 'Confirmed', 'Posted', 'Cancelled'];

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<InvoiceController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      ...
      context.read<InvoiceController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<InvoiceController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<InvoiceController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => InvoiceListItem(
  ...
  Widget _buildErrorState(InvoiceController ctrl) {
    return Center(
      child: Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Invoice not found' : 'No invoices yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
