...
class InvoiceRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getList({
    ...
    try {
      final r = await dio.get('/sales/invoices', queryParameters: {
        'page':     page,
        'per_page': perPage,
      ...
      return {
        'items': (pd['data'] as List).map((e) => InvoiceModel.fromJson(e)).toList(),
  ...
  Future<InvoiceDetailModel> getDetail(String enc) async {
    try {
      final r = await dio.get('/sales/invoices/$enc');
      return InvoiceDetailModel.fromJson(r.data);
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }

  Future<InvoiceFormOptions> getFormOptions() async {
    try {
      final r = await dio.get('/sales/invoices/form-options');
      return InvoiceFormOptions.fromJson(r.data);
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<void> cancel(int id, String reason) async {
    try {
      await dio.post('/sales/invoices/$id/cancel', data: {'cancel_reason': reason});
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<void> delete(int id) async {
    try {
      await dio.delete('/sales/invoices/$id');
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<Map<String, dynamic>> createPayment(int id) async {
    try {
      final r = await dio.post('/sales/invoices/$id/create-payment');
  ...
  Future<double?> getPriceFromList(int productId, int priceListId) async {
    try {
      final r = await dio.get(
        '/sales/invoices/price-from-list',
  ...
  Future<void> approve(int id) async {
    try {
      await dio.post('/sales/invoices/$id/approve');
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<void> reject(int id) async {
    try {
      await dio.post('/sales/invoices/$id/reject');
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
  }
  ...
  Future<Map<String, dynamic>> getSteps(int id) async {
    try {
      final r = await dio.get('/sales/invoices/$id/steps');
      return r.data as Map<String, dynamic>;
    } on DioException catch (e) {
      throw Exception(_err(e));
    }
