...
class _CustomerCreateWidgetState extends State<CustomerCreateWidget> {
  ...
  // --- Warna dan Style (Sesuai Referensi) ---
  final primaryColor = const Color(0xFF679436); // Warna hijau utama
  final accentColor = const Color(0xFFC8E6C9);  // Warna hijau muda untuk background input
  ...
  Future<void> _createCustomer() async {
    ...
    try {
      ...
      final body = {
        ...
        "address": _addressController.text, "country": _selectedCountry,
  ...
  // [DITAMBAHKAN] Helper widget untuk judul di dalam step, agar sama persis
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        // [DIUBAH] Menyamakan style AppBar: background putih, teks hitam
  ...
  Widget _buildStep1() {
    return Form(
      ...
      child: ListView(
        ...
        children: [
          // [DITAMBAHKAN] Judul di dalam step
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildDropdownField<int>(
            ...
            value: _selectedCountry, items: _countries.map((c) => c.id).toList(),
