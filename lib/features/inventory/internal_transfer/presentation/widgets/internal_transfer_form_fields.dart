...
class _ITLocationProduct {
  final int idProduct;
  final String productName;
  final double stockQty;

  _ITLocationProduct({required this.idProduct, required this.productName, this.stockQty = 0});

  factory _ITLocationProduct.fromMap(Map<String, dynamic> m) => _ITLocationProduct(
  ...
  @override
  bool operator ==(Object o) => o is _ITLocationProduct && o.idProduct == idProduct;
  @override
  int get hashCode => idProduct.hashCode;
}

class InternalTransferFormFields extends StatefulWidget {
  final InternalTransferFormModel formData;
  final InternalTransferFormOptions? formOptions;
  ...
  @override
  State<InternalTransferFormFields> createState() => _State();
}

class _State extends State<InternalTransferFormFields> with TickerProviderStateMixin {
  ...
  InternalTransferFormOptions? get _opts => widget.formOptions;
  ...
  bool _validateAndSync() {
    ...
    if (widget.formData.sourceLocation == widget.formData.destinationLocation) {
      _snack('Source and destination location cannot be the same');
      return false;
    }
  ...
  Future<void> _addProduct() async {
    ...
    final products = rawProducts.map(_ITLocationProduct.fromMap).toList();
    ...
    _ITLocationProduct? selected;
    ITUomOption? selectedUom;
        ...
        builder: (ctx, setSt) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                CustomSearchableDropdown<_ITLocationProduct>(
                  value: selected,
                  items: products,
                ...
                if (selected != null)
                  CustomSearchableDropdown<ITUomOption>(
                    value: selectedUom,
                    items: _opts?.uoms ?? [],
                    itemLabel: (u) => u.name,
    ...
    if (result != null && mounted) {
      final prod = result['product'] as _ITLocationProduct;
      final uom = result['uom'] as ITUomOption;
      ...
      setState(() {
        widget.formData.items.add(InternalTransferFormItem(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomFormInput(
            ...
            label: 'Notes',
            hintText: 'Write note for this internal transfer (optional)',
            maxLines: 3,
          ),
  ...
  Widget _buildBottomBar() => Container(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(
              widget.formData.isEditMode ? 'Update Internal Transfer' : 'Save Internal Transfer',
