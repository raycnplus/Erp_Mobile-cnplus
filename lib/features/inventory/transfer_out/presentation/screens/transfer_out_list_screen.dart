...
import 'package:erp_mobile_cnplus/features/inventory/transfer_out/presentation/widgets/transfer_out_list_item.dart';
import 'package:erp_mobile_cnplus/core/utils/colors.dart';
import 'package:erp_mobile_cnplus/shared/widgets/pagination_bottom_bar.dart';
import 'transfer_out_detail_screen.dart';

class TransferOutListScreen extends StatefulWidget {
  const TransferOutListScreen({super.key});
...
class _TransferOutListScreenState extends State<TransferOutListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<TransferOutController>().fetchList(),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Consumer<TransferOutController>(
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<TransferOutController>().search(v),
              decoration: InputDecoration(
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<TransferOutController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
          ...
          Expanded(
            child: Consumer<TransferOutController>(
              builder: (_, ctrl, __) {
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('${ctrl.total} transfer out', style: GoogleFonts.poppins(fontSize: 12, color: colorTextSubtle)),
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => TransferOutListItem(
                            to: ctrl.pageItems[i],
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => TransferOutDetailScreen(encryption: ctrl.pageItems[i].encryption),
                              ),
  ...
  Widget _buildErrorState(TransferOutController ctrl) {
    return Center(
      child: Padding(
  ...
  Widget _buildEmptyState(bool isSearching) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(isSearching ? Icons.search_off : Icons.upload_outlined, size: 80, color: colorGrey),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Transfer out not found' : 'No transfer out yet',
