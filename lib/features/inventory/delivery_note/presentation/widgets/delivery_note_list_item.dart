...
class DeliveryNoteListItem extends StatelessWidget {
  final DeliveryNoteModel dn;
  final VoidCallback onTap;

  const DeliveryNoteListItem({super.key, required this.dn, required this.onTap});
  ...
  Widget build(BuildContext context) {
    final color = Color(dn.statusColor);
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Flexible(
                          flex: 2,
                          child: Text(
                            _fmt(dn.scheduledDate),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: GoogleFonts.poppins(fontSize: 11, color: colorGrey),
                          ),
                        ),
                        if (dn.sourceDocument?.isNotEmpty == true) ...[
                    ...
                    if (dn.locationName?.isNotEmpty == true) ...[
                      const SizedBox(height: 2),
                      Row(
                        children: [
