...
import 'package:erp_mobile_cnplus/features/inventory/delivery_note/presentation/widgets/delivery_note_list_item.dart';
...
class _DeliveryNoteListScreenState extends State<DeliveryNoteListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<DeliveryNoteController>().fetchList(),
    );
  }
  ...
  void _goToForm() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const DeliveryNoteFormScreen()),
    ).then((_) {
      context.read<DeliveryNoteController>().fetchList(status: _selectedStatus);
    });
  }
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (v) => context.read<DeliveryNoteController>().search(v),
              decoration: InputDecoration(
                hintText: 'Look for references, customers or source doc...',
                ...
                suffixIcon: _searchCtrl.text.isNotEmpty
                    ? IconButton(
                        ...
                        onPressed: () {
                          _searchCtrl.clear();
                          context.read<DeliveryNoteController>().clearSearch();
                        },
                      )
                    : null,
                filled: true,
          ...
          Expanded(
            child: Consumer<DeliveryNoteController>(
              builder: (_, ctrl, __) {
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => DeliveryNoteListItem(
                            dn: ctrl.pageItems[i],
  ...
  Widget _buildErrorState(DeliveryNoteController ctrl) {
    return Center(
      child: Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            isSearching ? 'Delivery note not found' : 'No delivery notes yet',
            style: GoogleFonts.poppins(
              fontSize: 18,
