...
import 'package:erp_mobile_cnplus/features/inventory/delivery_note/presentation/widgets/delivery_note_form_fields.dart';
import 'package:erp_mobile_cnplus/core/utils/colors.dart';

class DeliveryNoteFormScreen extends StatefulWidget {
  final String? encryption;

  const DeliveryNoteFormScreen({super.key, this.encryption});
...
class _DeliveryNoteFormScreenState extends State<DeliveryNoteFormScreen> {
  late DeliveryNoteFormModel _form;
  ...
  void initState() {
    super.initState();
    _form = DeliveryNoteFormModel(encryption: widget.encryption);
    ...
    try {
      ...
      if (isEditMode) {
        ...
        if (d != null) {
          ...
          _form = DeliveryNoteFormModel.fromDetail(d);
        }
      }
    } catch (_) {}
