...
class StockReportListItem extends StatelessWidget {
  final StockReportModel report;
  final VoidCallback onTap;

  const StockReportListItem({
    super.key,
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  _statItem('Reserved', report.reserved.toStringAsFixed(0)),
                  _statItem('Available', report.available.toStringAsFixed(0)),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  _statItem(
                    'Outgoing',
                    report.forecastedOutgoing.toStringAsFixed(0),
                  ),
